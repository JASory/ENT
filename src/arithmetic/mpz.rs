...
/// Return x from i64
    ...
    /// Sets an integer of length -n with from a randomly generating function
    ...
    */
    ...
    /**
      ```
         ...
         let doublefact_100 = Mpz::sirp(1,100,2,0);// Even. Odd double factorial would be sirp(1,100,2,1)
         assert_eq!(
