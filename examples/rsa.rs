...
/*
 ...
 Naive implementation of RSA cryptosystem in k-bits, works for k greater than 256
...
fn generate_keys(k: u32) -> (Mpz, Mpz, Mpz) {
    ...
    let e = Mpz::from_u64(u64::prime_gen(64).unwrap()); // generates exponent between 2^63;2^64
