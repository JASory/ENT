...
fn arith() {
    ...
    // exponentiation
    assert_eq!(
        Mpz::from_i64(33).pow(42).to_string(),
    ...
    assert_eq!(
        Mpz::from_i64(-33).pow(43).to_string(),
...
fn bitwise() {
    ...
    assert_eq!(
        Mpz::from_u64(1).shl(65).to_u128().unwrap(),
    ...
    assert_eq!(
        Mpz::from_u128(36893488147419103232)
            .shr(65)
            .to_u64()
            .unwrap(),
        1
    ...
    assert_eq!(
        Mpz::from_u64(16841684685)
            .and(&Mpz::from_u64(1854618418))
            .to_u64()
            .unwrap(),
        1786982912
    );
